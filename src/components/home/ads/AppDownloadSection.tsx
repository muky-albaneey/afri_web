...
const AppDownloadSection = () => {
  return (
<div className="bg-[#8B4513] md:py-6 md:px-8  text-white relative w-full max-w-[1320px] mx-auto">
<div className="w-full md:hidden">
     ...
     <div className="w-full hidden md:flex flex-col items-center justify-center absolute top-4/12">
      <h1 className="md:text-[1.5rem] lg:text-[1rem] font-bold text-center">
        Enjoy Seamless Navigation on The Mobile App
      </h1>
      <p className="text-lg md:text-xl lg:text-[1rem] text-center mt-2">
        Download on the App Store and Get it on Google Play
      </p>
      <section className="w-full flex justify-center relative mt-8">
      <div className="flex items-center gap-3">
  <button className="bg-black flex items-center gap-2 py-2 rounded-md shadow-lg text-[10px]">
    <Image src="/logos_google-play-icon.svg" alt="Google Play" width={20} height={13} />
    Download on Google Play
  </button>
  <button className="bg-black flex items-center gap-2 py-2 rounded-md shadow-lg text-[10px]">
    <Image src="/apple-store.svg" alt="Apple Store" width={20} height={13} />
    Download on Apple Store
  </button>
</div>
