  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between md:items-center mb-6 gap-4">
        ...
        <button className="bg-[#8B4513] text-white px-4 py-2 rounded-md ml-3.5 md:ml-0">
          Add New Measurements
        </button>
      </div>

      {/* Saved Measurements Section */}
      <div className="border border-[#ebeaea] rounded-md p-4">
        <h2 className="text-[#000000] font-semibold">Saved Measurement</h2>
        <p className="text-gray-500 text-sm">your body measurement for tailors</p>

        {/* Measurements List */}
        {measurements.map((measurement, index) => (
          <div key={index} className="mt-4 border border-[#ebeaea] rounded-md p-4">
            <div className="flex flex-col md:flex-row items-start gap-3 justify-between md:items-center">
              <div >
                <h3 className="font-semibold">{measurement.type}</h3>
              ...
              <div className="flex gap-2">
                ...
                <button className="bg-[#8B4513] text-white px-3 py-1 rounded-md">
                  Share
                </button>
              </div>
            </div>
            <hr className="w-full border border-[#ebeaea] mt-6" />
            {/* Measurement Data */}
