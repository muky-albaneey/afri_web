  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-center p-6 bg-white">
      ...
      <div className="bg-white p-6 border rounded-lg shadow-md md:w-1/2">
        ...
        <div className="relative mt-2">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-brown-500"
          />
        </div>

        {/* Subscribe Button */}
        <button className="w-full mt-4 bg-[#77451D] text-white py-2 rounded-lg hover:bg-[#5d3617] transition">
          Subscribe
        </button>
      </div>
      ...
      <div className="w-full md:w-1/2 md:ml-6 mt-2">
        <div className="w-full h-40 md:h-64 bg-gray-400"></div>
      </div>
    </section>
  );
};
